...
from PyQt5.QtCore import QAbstractEventDispatcher, pyqtSignal, QObject
...
class mainWnd(PyQt5.QtWidgets.QMainWindow):
    WM_COMMAND = 0x0111
    def winEvent(self, message):
        if message.message == self.WM_COMMAND:
            if message.wParam >> 16 == THBN_CLICKED:
...
#            print "WA_TASKBARCREATED"
            ...
            print("iconic")
        return PyQt5.QtWidgets.QMainWindow.winEvent(self, message)
